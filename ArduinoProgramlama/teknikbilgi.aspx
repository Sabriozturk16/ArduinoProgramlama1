<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="teknikbilgi.aspx.cs" Inherits="ArduinoProgramlama.teknikbilgi" %>
...
<p><span class="showcase-title">Teknik Özellikler<br/></span></p>
<p>Sensorium Teknik Özellikleri inceleyin.</p>
<br/>
</div>
</div>	<!-- end. showcase -->
...
<span class="no-link">Teknik Özellikler</span>
</span>
</div><!-- end breadcrumb -->
...
<div class="componentheading"><strong>Sıcaklık Takip Sistemi Cihaz Teknik Özellikler</strong></div>
...
<!-- article-content -->
<div class="article">
<p><img style="float: right" alt="company" src="demo/cihaz_sensorium.jpg" class="pic-border">

Sağlık bakanlığının İlaç ve Aşı Dolabı Sıcaklık Takip Sistemi şartnamesine uygun olarak hazırlanmıştır.<br />
Sıcaklık ve nem değerlerini kayıt altına alabileceğiniz, profesyonel bir DATALOGGER.<br />
...
Kullanım kitapçığında belirtilmiş olan komutlar kullanılarak, cihaz rahatlıkla programlanabilir.<br />
Cihazın, kontrol etmesini istediğiniz minimum ve maksimum sıcaklık ve nem değer aralıklarını set edebilirsiniz.<br />
Belirlediğiniz set değerlerinin dışına çıkılması durumunda cihazın çıkışlarını kullanarak çeşitli uyarılar verdirebilirsiniz.<br />
...
Tek bir server üzerinden bir çok MAC DATLOG ETHERNET' i izleyebilirsiniz. Topladığınız verileri kayıt altına alabilir, dilediğiniz gibi analiz edebilirsiniz.<br /><br />



<strong>Cihaz tanıtım broşürünü incelemek için lütfen <a href="download/datlog_brosur.pdf" target="_blank">tıklayınız.</a></strong><br /><br />
