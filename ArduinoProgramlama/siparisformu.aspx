<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="siparisformu.aspx.cs" Inherits="ArduinoProgramlama.siparisformu" %>
...
<div class="showcase">
		...
		<div class="showcase-msg">
			<img src="demo/eposta.png" style="float: left; margin: 10px"
				alt="kurumsal" />
			<p>
				<span class="showcase-title">Sipariş <span>Formu</span><br /></span>
			</p>
			<br />
		</div>
	</div>
	...
	<div id="breadcrumbs">
		<a title="Home" href="index-2.html" id="breadcrumbs-home"></a> <span
			...
			<a class="pathway" href="#">İletişim</a> <span class="no-link">Sipariş
				Formu</span>
		</span>
	</div>
	<!-- end breadcrumb -->
...
<form action="https://sensorium.com.tr/form_mail_kurumsal.php" method="post">
										...
										<p class="form-subscr-field">
											<label for="telefon" id="">Telefonunuz: *</label>
											<input id="telefon" type="text" name="telefon"
												class="inputbox" size="10" " style="display: none;" />>Lütfen
										...
										<p class="form-subscr-field">
											<label for="eposta" id="contact_email_label">E-Posta
												...
												name="eposta" class="inputbox" size="10"  /> <label
										...
										<p class="form-subscr-field">
											<label for="urun" id="">Sipariş Edilen
												Ürün: *</label> <input id="urun" type="text" name="urun"
												class="inputbox" size="10"  />
										</p>
										<p class="form-subscr-field">
											<label for="miktar" id="">Sipariş
												Miktarı: *</label> <input id="miktar" type="text"
												name="miktar" class="inputbox" size="10"  />
										</p>
										<p class="form-subscr-field">
											<label for="mesaj" id="comment_label">Açıklama:</label>
											<textarea id="mesaj" name="mesaj" rows="8" cols="30"></textarea>
											<label class="error" for="mesaj" id="message_error"
												style="display: none;">Lütfen açıklama giriniz.</label>
										</p>
										<div>
											<script type="text/javascript">
